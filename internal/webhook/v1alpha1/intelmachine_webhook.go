...
func SetupIntelMachineWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&v1alpha1.IntelMachine{}).
		...
		WithDefaulter(&IntelMachineCustomDefaulter{
			...
			DefaultNodeGuid:   "default-node-guid",
		}).
		Complete()
}

// +kubebuilder:webhook:path=/mutate-intelmachine-v1alpha1,mutating=true,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=intelmachines,verbs=create;update,versions=v1alpha1,name=mutate-intelmachine-v1alpha1.infrastructure.cluster.x-k8s.io,admissionReviewVersions=v1
...
func (d *IntelMachineCustomDefaulter) Default(_ context.Context, obj runtime.Object) error {
	machine, ok := obj.(*v1alpha1.IntelMachine)
	if !ok {
...
func (d *IntelMachineCustomDefaulter) applyDefaults(machine *v1alpha1.IntelMachine) {
	if *machine.Spec.ProviderID == "" {
		machine.Spec.ProviderID = &d.DefaultProviderId
	}
	if machine.Spec.NodeGUID == "" {
		machine.Spec.NodeGUID = d.DefaultNodeGuid
	}
}

// +kubebuilder:webhook:path=/validate-intelmachine-v1alpha1,mutating=false,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=intelmachines,verbs=create;update,versions=v1alpha1,name=validate-intelmachine-v1alpha1.infrastructure.cluster.x-k8s.io,admissionReviewVersions=v1
...
func (v *IntelMachineCustomValidator) ValidateUpdate(_ context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	machine, ok := newObj.(*v1alpha1.IntelMachine)
	if !ok {
...
func validateIntelMachine(machine *v1alpha1.IntelMachine) error {
...
func validateIntelMachineName(machine *v1alpha1.IntelMachine) *field.Error {
...
func validateIntelMachineSpec(machine *v1alpha1.IntelMachine) *field.Error {
