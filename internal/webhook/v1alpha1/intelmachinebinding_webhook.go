...
func SetupIntelMachineBindingWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).For(&v1alpha1.IntelMachineBinding{}).
		WithValidator(&IntelMachineBindingCustomValidator{}).
		WithDefaulter(&IntelMachineBindingCustomDefaulter{
			DefaultNodeGuid:                 "default-node-guid", // TODO? do we want default values of fail if empty? (valdiator)
...
// +kubebuilder:webhook:path=/mutate-intelmachinebinding-v1alpha1,mutating=true,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=intelmachinebindings,verbs=create;update,versions=v1alpha1,name=mutate-intelmachinebinding-v1alpha1.infrastructure.cluster.x-k8s.io,admissionReviewVersions=v1
...
func (d *IntelMachineBindingCustomDefaulter) Default(_ context.Context, obj runtime.Object) error {
	binding, ok := obj.(*v1alpha1.IntelMachineBinding)
	if !ok {
...
func (d *IntelMachineBindingCustomDefaulter) applyDefaults(binding *v1alpha1.IntelMachineBinding) {
	if binding.Spec.NodeGUID == "" {
		binding.Spec.NodeGUID = d.DefaultNodeGuid
	}
...
// +kubebuilder:webhook:path=/validate-intelmachinebinding-v1alpha1,mutating=false,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=intelmachinebindings,verbs=create;update,versions=v1alpha1,name=validate-intelmachinebinding-v1alpha1.infrastructure.cluster.x-k8s.io,admissionReviewVersions=v1
...
func (v *IntelMachineBindingCustomValidator) ValidateUpdate(_ context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	binding, ok := newObj.(*v1alpha1.IntelMachineBinding)
	if !ok {
...
func validateIntelMachineBinding(binding *v1alpha1.IntelMachineBinding) error {
...
func validateIntelMachineBindingName(binding *v1alpha1.IntelMachineBinding) *field.Error {
...
func validateIntelMachineBindingSpec(binding *v1alpha1.IntelMachineBinding) *field.Error {
