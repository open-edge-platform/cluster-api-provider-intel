...
var _ = Describe("IntelCluster Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			...
			Expect(kerrors.IsNotFound(k8sClient.Get(ctx, defaultResourceFilter, &infrav1alpha2.IntelCluster{}))).To(BeTrue())
		...
		AfterEach(func() {
			...
			Eventually(func(g Gomega) {
				g.Expect(kerrors.IsNotFound(k8sClient.Get(ctx, defaultResourceFilter, &infrav1alpha2.IntelCluster{}))).To(BeTrue())
		...
		It("should successfully reconcile the resource", func() {
			resource := &infrav1alpha2.IntelCluster{}
