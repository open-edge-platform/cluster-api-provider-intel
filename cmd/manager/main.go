...
func main() {
	// TODO: refactor flag parsing into a Config object
	...
	var inventoryEndpoint string
	var enableTracing bool
	var enableMetrics bool
	var useInventoryStub bool
	...
	flag.StringVar(&inventoryEndpoint, "inventory-endpoint", "mi-inventory:50051",
		"The address where inventory is accessible at.")
	flag.BoolVar(&enableTracing, "enable-tracing", false, "Enable tracing for provider and other clients.")
	flag.BoolVar(&enableMetrics, "enable-metrics", false, "Enable metrics for provider and other clients.")
	flag.BoolVar(&useInventoryStub, "use-inv-stub", false, "Use stubbed responses for inventory client.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6a16cdd8.cluster.x-k8s.io",
	...
	if err = (&controller.IntelMachineReconciler{
		Client:          mgr.GetClient(),
		Scheme:          mgr.GetScheme(),
		InventoryClient: inventoryClient,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "IntelMachine")
		setupLog.Info("closing inventory client")
		inventoryClient.Close()
		os.Exit(1)
	}
	if err = (&controller.IntelClusterReconciler{
		Client:          mgr.GetClient(),
		Scheme:          mgr.GetScheme(),
		InventoryClient: inventoryClient,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "IntelCluster")
		setupLog.Info("closing inventory client")
		inventoryClient.Close()
		os.Exit(1)
	}
	...
	// make sure the inventory client is closed when the container receives the following signals
